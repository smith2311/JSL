...
class SwitchFundsScreen extends ConsumerStatefulWidget {
  final int fundId;
  ...
  final String clientName; // Added clientName parameter

  const SwitchFundsScreen({
    super.key,
    ...
    required this.clientName, // Added required clientName
  });

  @override
  ConsumerState<SwitchFundsScreen> createState() => _SwitchFundsScreenState();
}

class _SwitchFundsScreenState extends ConsumerState<SwitchFundsScreen> {
  ...
  void initState() {
    ...
    // Debug logging
    print('🔍 SwitchFundsScreen initialized with:');
    ...
    print('   clientName: ${widget.clientName}'); // Added clientName log
  }
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () {
            ...
            print('🚀 Navigating to switch-fund-detail...');
            ...
            context.pushNamed(
              ...
              extra: {
                ...
                'clientName': widget.clientName, // Pass clientName forward
              },
            );
          },
          borderRadius: BorderRadius.circular(12),
